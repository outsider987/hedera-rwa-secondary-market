...
writeFileSync('docs/evidence/046-cloud-local.json',JSON.stringify({recordedAt:new Date().toISOString(),kind:'Explicit public fixtures and isolated read-only wallet; no live transactions',results},null,2)+'\n');
