...
- `based_on_commit: 25bc5de9a6e54ae3f4a8a257055f8cb07c319d3e`（本輪乾淨起點，非包含此 handoff 的 commit）。
- 分支 `diagnostic/t01a-sdk-load`；前次文件的 b5640298 已驗為祖先。實際 HEAD 由 Git 讀取。
...
`docs/ai-usage/010-t01b-1-manual.md`、`docs/prompts/011-t01b-1-manual.md`、
...
文件與成果一起 commit，確認 clean boundary；不 push／merge。
