# T00 bootstrap — historical AI usage
...
The former shared source table is retained here as a historical snapshot;
its placement does not date its authorship to T00. Current third-party uses
are listed in [ATTRIBUTION.md](../ATTRIBUTION.md).
