...
export default function OrderBook({ open }: { open: Order[] }) {
  return <section className="market-book" aria-labelledby="book-heading"><h3 id="book-heading" tabIndex={-1}>Order book</h3><p className="muted">Funds are not reserved</p>
