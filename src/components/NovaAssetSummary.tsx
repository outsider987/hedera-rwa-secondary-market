...
export default function NovaAssetSummary() {
  return <div className="hb:grid hb:items-center hb:gap-8 hb:lg:grid-cols-2">
    ...
    <figure className="hb:m-0">
      <img src={import.meta.env.BASE_URL+'assets/nova-demo-equity.png'} alt="Illustrative NOVA certificate labeled Demo Equity and Hedera Testnet" width="1536" height="1024" className="hb:block hb:w-full hb:h-auto"/>
